...
public interface OrderProductMapper {
    ...
    List<OrderProduct> toOrderProductsList(Iterable<OrderProductEntity> orderProductEntities); //Definimos el metodo de listar ya que no está predeterminado en el CRUD
